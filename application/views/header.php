...
?>
			<ul>
				<li><a href="<?php echo site_url("levelling/new_project"); ?>">Yeni Proje</a></li>
...
<?php else: ?>
			<ul>
				...
				<li><a href="http://www.geomatikuygulamalar.com/v2/store/application/8364185514">Uygulama Sayfası</a></li>
			</ul>
<?php endif; ?>
	    </div>
		<div id="content">