    <tr align="center">
      <td><input class="input-mini" type="text" name="id0" value="<?php echo isset($id[0])?$id[0]:null; ?>"></td>
       <td></td> <td></td> <td></td>  <td></td> <td></td> <td></td> <td></td> <td></td>  <td></td>
      <td></td>
      <td><input class="input-mini"  type="text" name="H0" value="<?php echo isset($H[0])?$H[0]:null; ?>"></td>
    </tr>
    <tr align="center">
      <td></td>
      <td><input class="input-mini" type="text" name="f_deltah0"  value="<?php echo isset($f_deltah[0])?$f_deltah[0]:null; ?>"></td>
      <td><input class="input-mini" type="text" name="f_l0"  value="<?php echo isset($f_l[0])?$f_l[0]:null; ?>"></td>
      <td><input class="input-mini" type="text" name="b_deltah0"  value="<?php echo isset($b_deltah[0])?$b_deltah[0]:null; ?>"></td>
      <td><input class="input-mini" type="text" name="b_l0"  value="<?php echo isset($b_l[0])?$b_l[0]:null; ?>"></td>
