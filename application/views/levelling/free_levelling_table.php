...
?>
    ...
    <tr align="center">
      <td></td>
      <td><input class="numerical_input" type="text" name="f_deltah<?php echo $i; ?>" size="8" value="<?php echo isset($f_deltah[$i])?$f_deltah[$i]:null; ?>"></td>
      <td><input class="numerical_input" type="text" name="f_l<?php echo $i; ?>" size="5" value="<?php echo isset($f_l[$i])?$f_l[$i]:null; ?>"></td>
      <td><input class="numerical_input" type="text" name="b_deltah<?php echo $i; ?>" size="8" value="<?php echo isset($b_deltah[$i])?$b_deltah[$i]:null; ?>"></td>
